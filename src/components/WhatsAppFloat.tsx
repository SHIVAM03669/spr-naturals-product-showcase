...
export default function WhatsAppFloat({ 
  phoneNumber = "+919876543210", // Default WhatsApp number - replace with actual number
  message = "Hello! I'm interested in SPR Naturals products. Could you please provide more information?" 
}: WhatsAppFloatProps) {
      ...
      >
        ...
        <div 
          className="
            ...
            border-l-4 border-l-gray-800 border-t-4 border-t-transparent border-b-4 border-b-transparent
            opacity-0
            transition-opacity duration-200
            pointer-events-none
            group-hover:opacity-100
